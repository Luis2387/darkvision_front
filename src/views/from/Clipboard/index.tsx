        ...
        <React.Fragment>
            ...
            <Row className="mb-3">
                ...
                <Col lg={6} md={9} sm={12}>
                    ...
                    <small>
                        you can define a <code>data-clipboard-action</code> attribute to specify if you want to either <code>copy</code> or <code>cut</code> content</small><br />
            ...
            <Row className="mb-0">
                ...
                <Col lg={6} md={9} sm={12}>
                    ...
                    <CopyToClipboard text={copyText3} onCopy={handleCopy3} options={{ format: 'text/plain' }}>
                        <Link to="#" className="btn btn-primary mt-2">Copy to clipboard</Link>
                    </CopyToClipboard>
                </Col>
            </Row>
        </React.Fragment>
