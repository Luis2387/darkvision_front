              ...
              <table className="table table-hover table-borderless table-sm mb-0">
                <tbody>
                  <tr>
                    <td>
                      <div className="d-inline-block align-middle">
                        <img src={avatar1} alt="user image" className="img-radius align-top m-r-15" width="40" />
                  ...
                  <tr>
                    <td>
                      <div className="d-inline-block align-middle">
                        <img src={avatar2} alt="user image" className="img-radius align-top m-r-15" width="40" />
                        <div className="d-inline-block">
                  ...
                  <tr>
                    <td>
                      <div className="d-inline-block align-middle">
                        <img src={avatar3} alt="user image" className="img-radius align-top m-r-15" width="40" />
                        <div className="d-inline-block">
                  ...
                  <tr>
                    <td>
                      <div className="d-inline-block align-middle">
                        <img src={avatar4} alt="user image" className="img-radius align-top m-r-15" width="40" />
                        <div className="d-inline-block">
