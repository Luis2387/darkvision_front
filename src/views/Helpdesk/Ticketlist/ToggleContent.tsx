                            ...
                            <div className="modal-body border-bottom px-4">
                                <div className="row">
                                    <div className="col-md-7">
                                        ...
                                        Closed
                                        <p className="list-inline-item mb-0"><img src={p1} alt=""
                                            className="wid-20 rounded me-1 img-fluid" />Alpha pro</p>
                                    </div>
                            ...
                            <div className="modal-body border-bottom px-4">
                                <div className="row">
                                    <div className="col-auto">
                                        <img className="media-object wid-60 img-radius" src={avatar5}
