                        ...
                        <Row onClick={() => handleDropDown(25)}>
                            <div className="col-sm-auto mb-3 mb-sm-0">
                                <div className="d-sm-inline-block d-flex align-items-center">
                                    <img className="media-object wid-60 img-radius" src={avatar1}
                                        alt="Generic placeholder image " />
                                    <div className="ms-3 ms-sm-0">
                                        <ul className=" text-sm-center list-unstyled mt-2 mb-0 d-inline-block">
                                            <li className="list-unstyled-item"><Link to="#" className="link-secondary">1 Ticket</Link></li>
                                            <li className="list-unstyled-item"><Link to="#" className="link-danger"><i className="fas fa-heart"></i>&nbsp;3</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <Col>
                                <div className="popup-trigger">
                                    ...
                                    <div className="help-sm-hidden">
                                        <ul className="list-unstyled mt-2 mb-0 text-muted">
                                            <li className="d-sm-inline-block d-block mt-1"><img src={p1} alt=""
                                                className="wid-20 rounded me-2 img-fluid" />Piaf able</li>
                                            <li className="d-sm-inline-block d-block mt-1" ><img src={avatar5} alt=""
                                                className="wid-20 rounded ms-1 me-1 img-fluid" />&nbsp;Assigned to <b>Robert alia</b></li>&nbsp;
                                    ...
                                    <div
                                        ...
                                        <div className="bg-body mb-3 p-3">
                                            <h6><img src={avatar5} alt=""
                                                className="wid-20 avatar med-2 rounded" />Last comment from <a href="#"
                                ...
                                <div className="mt-2">
                                    <Link to="/admins/helpdesk-ticket-details" className="me-2 btn btn-sm btn-light-primary"><i
                                        className="feather icon-eye me-1"></i>View Ticket</Link>&nbsp;
                                    <Link to="#" className="me-3 btn btn-sm btn-light-danger"><i
                            ...
                            <Col>
                                <div className="popup-trigger">
                                    ...
                                    <div className="help-md-hidden">
                                        <div className="bg-body mb-3 p-3">
                                            <h6><img src={avatar5} alt="" className="wid-20 avatar me-2 rounded" />Last comment from <a href="#" className="link-secondary">Robert alia:</a></h6>
                                            <p className="mb-0"><b>hello John lui,<br /></b>you need to create
                                                <b> "toolbar-options" div only</b> once in a page&nbsp;in your code,<br />
                                                this div fill found every "td" tag in your page <br />just remove those
                                                things
                    ...
                    <CardBody>
                        <Row>
                            ...
                            <Col>
                                    ...
                                    <div className="help-sm-hidden">
                                        <ul className="list-unstyled mt-2 mb-0 text-muted">
                                            <li className="d-sm-inline-block d-block mt-1"><img src={p1} alt=""
                                                className="wid-20 rounded me-2 img-fluid" />Piaf able</li>
                                            <li className="d-sm-inline-block d-block mt-1"><img src={avatar5} alt=""
                                                className="wid-20 rounded ms-1 me-1 img-fluid" />&nbsp;Assigned to <b>Robert alia</b>
                                            </li>&nbsp;
                                            <li className="d-sm-inline-block d-block mt-1"><i
                                                className="wid-20 material-icons-two-tone text-center f-14 me-2">calendar_today</i>Updated
                                                22 hours ago</li>&nbsp;
                                ...
                                <div className="mt-2">
                                    <Link to="/admins/helpdesk-ticket-details" className="me-2 btn btn-sm btn-light-primary"><i className="feather icon-eye me-1"></i>View Ticket</Link>&nbsp;
                                    <Link to="#" className="me-3 btn btn-sm btn-light-danger"><i className="feather icon-trash-2 me-1"></i>Delete</Link>
                                </div>
                            </Col>
                        </Row>
                    </CardBody>
