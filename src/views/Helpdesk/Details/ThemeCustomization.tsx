    ...
    return (
        <React.Fragment>
            <Col lg={8}>
                <Card>
                    <CardHeader>
                        <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-lock icon-svg-primary wid-20"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg><span className="p-l-5">Private Ticket
                            #1831786</span></h5>
                    </CardHeader>
                        ...
                        <Row className="align-items-center">
                            ...
                            <Col md={4} className="text-md-end">
                                <div className="btn-star">
                                    <Link to="#!" className="btn btn-light-success btn-sm">Mark as unread</Link>
                                    <Link to="#!"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-star icon-svg-warning wid-20"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg> </Link>
                                </div>
                            </Col>
                        </Row>
                    </CardBody>
                        ...
                        <Row className="align-items-center">
                            <Col md={12}>
                                ...
                                <button type="button" className="btn btn-sm my-2 me-1 btn-light-danger"><i
                                    className="mx-1 feather icon-user-check"></i>Customer Notes</button>
                            </Col>
                        </Row>
                    </div>
                        ...
                        <Row>
                            <div className="col-sm-auto mb-3 mb-sm-0">
                                <div className="d-sm-inline-block d-flex align-items-center">
                                    <img className="wid-60 img-radius mb-2" src={avatar5}
                                        ...
                                        <ul className="list-unstyled mb-0">
                                            <li className="d-inline-block f-20 me-1">
                                                <a href="#" data-bs-toggle="tooltip" title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-edit icon-svg-success wid-20"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                                                </a>
                                            </li>&nbsp;
                    ...
                    <CardBody className="border-bottom">
                        <Row>
                            <div className="col-sm-auto mb-3 mb-sm-0">
                                <div className="d-sm-inline-block d-flex align-items-center">
                                    <img className="wid-60 img-radius mb-2" src={avatar4} alt="Generic placeholder image " />
                                    <div className="ms-3 ms-sm-0  text-sm-center">
                            ...
                            <Col>
                                ...
                                <Row className="text-center mb-2">
                                    <div className="col-xl-2 col-lg-3 col-sm-4 col-xs-12">
                                        <img src={lightBox1} className="img-fluid m-b-10" alt="" />
                                    </div>
                                    <div className="col-xl-2 col-lg-3 col-sm-4 col-xs-12">
                                        <img src={lightBox2} className="img-fluid m-b-10" alt="" />
                                    </div>
                                    <div className="col-xl-2 col-lg-3 col-sm-4 col-xs-12">
                                        <img src={lightBox5} className="img-fluid m-b-10" alt="" />
                                    </div>
                                    <div className="col-xl-2 col-lg-3 col-sm-4 col-xs-12">
                                        <img src={lightBox6} className="img-fluid m-b-10" alt="" />
                                    </div>
                                    <div className="col-xl-2 col-lg-3 col-sm-4 col-xs-12">
                                        <img src={lightBox1} className="img-fluid m-b-10" alt="" />
                                    </div>
