                        ...
                        <tbody>
                            {paginatedData.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                        <Link to="#" className="btn btn-sm btn-light-success me-1"><i className="feather icon-edit"></i></Link>
                                        <Link to="#" className="btn btn-sm btn-light-danger"><i className="feather icon-trash-2"></i></Link>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
