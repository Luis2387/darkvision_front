    ...
    <React.Fragment>
            ...
            <Masonry columnsCount={4} gutter="0px">
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item graphic" style={{width:"auto",padding:"8px"}}>
                    <Link className="card-gallery" data-fslightbox="gallery" to={gallaryGrid2}>
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item graphic" style={{width:"auto",padding:"8px"}}>
                    <Link className="card-gallery" data-fslightbox="gallery" to={gallaryGrid7}>
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item graphic" style={{width:"auto",padding:"8px"}}>
                    <Link className="card-gallery" data-fslightbox="gallery" to={gallaryGrid12}>
