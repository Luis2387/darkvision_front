...
const ShowAll = () => {
    return (
        <React.Fragment>
            <ResponsiveMasonry
                columnsCountBreakPoints={{300: 1, 600: 2, 760: 3}}
            >
            <Masonry columnsCount={4} gutter="0px">
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item graphic" style={{width:"auto",padding:"8px"}}>
                    <a className="card-gallery" data-fslightbox="gallery" href={gallaryGrid2}>
                        <img className="img-fluid" src={gallaryGrid2} alt="Card image" />
                        <div className="gallery-hover-data card-body">
                            <div className="position-relative text-end">
                                <div className="form-check prod-likes d-inline-block">
                            ...
                            <div className="d-flex align-items-center">
                                <div className="flex-shrink-0">
                                    <div className="chat-avtar">
                                        <img className="rounded-circle img-fluid wid-30" src={avatar2} alt="User image" />
                                    </div>
                                </div>
                                <div className="flex-grow-1 mx-2 text-white">
                                    <p className="mb-0 text-truncate w-100">Alexander</p>
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item animation" style={{width:"auto",padding:"8px"}}>
                    <a className="card-gallery" data-fslightbox="gallery" href={gallaryGrid3}>
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item product" style={{width:"auto",padding:"8px"}}>
                    <a className="card-gallery" data-fslightbox="gallery" href={gallaryGrid5}>
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item graphic" style={{width:"auto",padding:"8px"}}>
                    <a className="card-gallery" data-fslightbox="gallery" href={gallaryGrid7}>
                        <img className="img-fluid" src={gallaryGrid7} alt="Card image" />
                        <div className="gallery-hover-data card-body">
                            <div className="position-relative text-end">
                                <div className="form-check prod-likes d-inline-block">
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item animation" style={{width:"auto",padding:"8px"}}>
                    <a className="card-gallery" data-fslightbox="gallery" href={gallaryGrid8}>
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item product" style={{width:"auto",padding:"8px"}}>
                    <a className="card-gallery" data-fslightbox="gallery" href={gallaryGrid10}>
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item graphic" style={{width:"auto",padding:"8px"}}>
                    <a className="card-gallery" data-fslightbox="gallery" href={gallaryGrid12}>
                        <img className="img-fluid" src={gallaryGrid12} alt="Card image" />
                        <div className="gallery-hover-data card-body">
                            <div className="position-relative text-end">
                                <div className="form-check prod-likes d-inline-block">
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item animation" style={{width:"auto",padding:"8px"}}>
                    <a className="card-gallery" data-fslightbox="gallery" href={gallaryGrid13}>
                ...
                <div className="col-xxl-3 col-md-4 col-sm-6 element-item product" style={{width:"auto",padding:"8px"}}>
                    <a className="card-gallery" data-fslightbox="gallery" href={gallaryGrid15}>
