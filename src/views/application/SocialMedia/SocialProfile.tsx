    ...
    return (
        <React.Fragment>
            <Card className="social-profile">
                <img src={profileCover} alt="" className="w-100 h-100 card-img-top" />
                <Card.Body className="pt-0">
                    <Row className="align-items-end">
                        <div className="col-md-auto text-md-start">
                            <img className="img-fluid img-profile-avtar" src={avatar5} alt="User image" />
                        </div>
                        <Col>
                            <Row className="justify-content-between align-items-end">
                                <Col md={5} xl={6} className="soc-profile-data">
                                    <h5 className="mb-1">Stebin Ben</h5>
                                    <p className="mb-0">UI/UX Designer <Link to="#" className="link-primary">Follow</Link></p>
                                </Col>
                                <Col md={7} xl={6} xxl={5}>
