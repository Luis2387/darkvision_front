            ...
            <Col lg={4} xxl={3}>
                    ...
                    <Card.Body>
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <div className="flex-shrink-0">
                                <Link to="#" className="avtar avtar-s bg-primary rounded-circle text-white"><i className="ti ti-plus f-18"></i></Link>
                            </div>
                        </div>
                    </Card.Body>
                </Card>
                ...
                <Card>
                    ...
                    <ul className="list-group list-group-flush">
                        <li className="list-group-item">
                            <div className="d-flex align-items-center">
                                <div className="flex-shrink-0">
                                    <img className="rounded img-fluid wid-40" src={avatar1} alt="User image" />
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="d-flex align-items-center">
                                <div className="flex-shrink-0">
                                    <img className="rounded img-fluid wid-40" src={avatar5} alt="User image" />
                                </div>
                                <div className="flex-grow-1 mx-2">
                        ...
                        <li className="list-group-item">
                            <div className="d-flex align-items-center">
                                <div className="flex-shrink-0">
                                    <img className="rounded img-fluid wid-40" src={avatar3} alt="User image" />
                                </div>
                                <div className="flex-grow-1 mx-2">
                        ...
                        <li className="list-group-item">
                            <div className="d-flex align-items-center">
                                <div className="flex-shrink-0">
                                    <img className="rounded img-fluid wid-40" src={avatar4} alt="User image" />
                                </div>
                                <div className="flex-grow-1 mx-2">
                ...
                <Card>
                    ...
                    <Card.Body>
                        <Row className="g-2">
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal1}>
                                    <img src={socgal1} alt="img" className="card-img" height={97.83} />
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal2}>
                                    <img src={socgal2} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal3}>
                                    <img src={socgal3} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal4}>
                                    <img src={socgal4} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal5}>
                                    <img src={socgal5} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal6}>
                                    <img src={socgal6} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal7}>
                                    <img src={socgal7} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal8}>
                                    <img src={socgal8} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link to="#" className="img-post card" data-lightbox={socgal9}>
                                    <img src={socgal9} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
