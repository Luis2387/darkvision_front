                    ...
                    <ul className="list-inline me-auto mb-0">
                        <OverlayTrigger
                            ...
                            <li className="list-inline-item align-bottom">
                                <Link to="#" id="pc_event_remove" className="avtar avtar-s btn-link-danger btn-pc-default w-sm-auto" onClick={() => { setDelet(!delet); setModal(false); }}>
                        ...
                        <OverlayTrigger
                            ...
                            <li className="list-inline-item align-bottom">
                                <Link to="#" id="pc_event_edit" className="avtar avtar-s btn-link-success btn-pc-default" onClick={() => { handleModal(); setModal(false); }}>
