...
import { getChat } from "../../../toolkit/Chat/reducer";
import { chatList } from "../../../Common/jsonData/Application/chat";
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            <div className="chat-avtar">
                                                                <div className="flex-shrink-0">
                                                                    <img className="rounded-circle img-fluid" width={40} height={40} src={item.avatar} alt="User image" />
                                    ...
                                    <div className="list-group list-group-flush">
                                        ...
                                        <div className="list-group-item">
                                            <div className="d-flex align-items-center">
                                                <div className="flex-shrink-0">
                                                    <div className="chat-avtar">
                                                        <img className="rounded-circle img-fluid" width={40} height={40} src={avatar5} alt="User image" />
