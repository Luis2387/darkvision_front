...
import { getuserChat, onAddMessage, onDeleteMessage } from "../../../toolkit/Chat/reducer";
...
const ChatContent = ({ userChatData, Chat_Box_Username, Chat_Box_Image, sidecollapse, setSidecollapse, opne, setOpne }: any) => {
    ...
    useEffect(() => {
        dispatch(getuserChat(chatList as any))
    }, [dispatch]);

    // const currentData = Array.isArray(userChat) ? userChat.filter((i: any) => {
    //     // console.log("i.name === Chat_Box_Username", i.name, Chat_Box_Username)
    //     return i.name === Chat_Box_Username
    // }) : [];
            ...
            <div className="chat-content">
                <div className="d-flex align-items-center mb-3">
                    <ul className="list-inline me-auto mb-0">
                        <li className="list-inline-item align-bottom">
                            <Link to="#" className="d-xxl-none avtar avtar-s btn-link-secondary" onClick={() => setSidecollapse(!sidecollapse)}>
                                <i className="ti ti-menu-2 f-18"></i>
                            </Link>
                            <Link to="#" className="d-none d-xxl-inline-flex avtar avtar-s btn-link-secondary" onClick={() => setSidecollapse(!sidecollapse)}>
                                <i className="ti ti-menu-2 f-18"></i>
                            </Link>
                        </li>
                        <li className="list-inline-item">
                            <div className="d-flex align-items-center">
                                <div className="chat-avtar">
                                    <img className="rounded-circle img-fluid" width={40} height={40} src={Chat_Box_Image || avatar5} alt="User image" />
                    ...
                    <ul className="list-inline ms-auto mb-0">
                        ...
                        <li className="list-inline-item" >
                            <Link to="#" className="d-xxl-none avtar avtar-s btn-link-secondary" onClick={() => setOpne(!opne)}>
                                <i className="ti ti-info-circle f-18"></i>
                            </Link>
                            <Link to="#" className="d-none d-xxl-inline-flex avtar avtar-s btn-link-secondary" onClick={() => setOpne(!opne)}>
                                <i className="ti ti-info-circle f-18"></i>
                            </Link>
                        </li>
                        <li className="list-inline-item">
                ...
                <Card className="bg-body shadow-none mb-0">
                    <SimpleBar className="scroll-block chat-message" data-simplebar="init" ref={scrollMsg}>
                        <Card.Body>
                            {
                                (userChatData || [])?.map((chats: any, chatIdx: number) => {
                                    return (
                                                ...
                                                chats.roomNO === 1 ?
                                                    ...
                                                    <div className="message-in">
                                                        <div className="d-flex">
                                                            <div className="flex-shrink-0">
                                                                <div className="chat-avtar">
                                                                    <img className="rounded-circle img-fluid" src={Chat_Box_Image || avatar3} width={40} height={40} alt="User image" />
                                                                    <i className="chat-badge bg-success"></i>
                                                                </div>
                                                            </div>
