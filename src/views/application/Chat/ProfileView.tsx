                    ...
                    <div className="card bg-transparent shadow-none border-0 mb-0">
                        <div className="text-center card-body position-relative p-3 pb-0 px-0">
                            ...
                            <div className="position-absolute end-0 top-0 p-2 d-none d-xxl-inline-flex">
                                <Link to="#" className="avtar avtar-xs btn-link-danger btn-pc-default" onClick={() => setOpne(!opne)}>
                                    <i className="ti ti-x f-16"></i>
                                </Link>
                            </div>
                            <div className="chat-avtar d-inline-flex mx-auto">
                                <img className="rounded-circle img-fluid" src={Chat_Box_Image || avatar5} width={100} height={100} alt="User image" />
                            </div>
                                    ...
                                    <div className="py-3">
                                        <div className="d-flex align-items-center mb-2">
                                            <div className="flex-shrink-0">
                                                <Link to="#" className="avtar avtar-s btn-light-success">
                                        ...
                                        <div className="d-flex align-items-center mb-2">
                                            <div className="flex-shrink-0">
                                                <Link to="#" className="avtar avtar-s btn-light-danger">
                                        ...
                                        <div className="d-flex align-items-center mb-2">
                                            <div className="flex-shrink-0">
                                                <Link to="#" className="avtar avtar-s btn-light-primary">
