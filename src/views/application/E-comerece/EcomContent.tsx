                ...
                <div className="d-sm-flex align-items-center mb-4">
                    ...
                    <ul className="list-inline ms-auto my-1">
                        ...
                        <li className="list-inline-item align-bottom">
                            <Link to="#" className="d-xxl-none btn btn-link-secondary">
                                <i className="ti ti-filter f-16"></i> Filter
                            </Link>
                            <Link to="#" className="d-none d-xxl-inline-flex btn btn-link-secondary" aria-expanded={collapse} onClick={() => handleCollapse()}>
                                <i className="ti ti-filter f-16"></i> Filter
                            </Link>
                        </li>
                    </ul>
