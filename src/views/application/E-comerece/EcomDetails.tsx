...
import { Badge, Card, CardBody, Form, Offcanvas } from "react-bootstrap";
    ...
    return (
        <React.Fragment>
            <Offcanvas show={show} onHide={handleClose} placement="end" backdrop={true}>
                <Offcanvas.Header closeButton className="align-items-center justify-content-between">
                    <Offcanvas.Title>Product Details</Offcanvas.Title>
                </Offcanvas.Header>
                <Offcanvas.Body>
                    <Card className="product-card shadow-none border-0">
                        <img className="card-img-top p-0" src={ecomDetails?.imageUrl} alt="" width={302} height={302} />
                        ...
                        </CardBody>
                        {
                            ...
                            <CardBody className="position-absolute start-0 top-0">
                    ...
                    <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item px-0">
                            <div className="d-inline-flex align-items-center justify-content-between w-100">
                                ...
                                <h6 className="mb-0"><img src={brand2} alt="user-image" width={40} /></h6>
                            </div>
                        </li>
                    </ul>
                </Offcanvas.Body>
