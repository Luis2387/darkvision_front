                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <Row className="align-items-center">
                                                <div className="col-auto pe-0">
                                                    <img src={item.teamLeaderImg} alt="user-image" className="wid-40 rounded" />
                                                </div>
                                                <Col>
                                        ...
                                        <td>
                                            <div className="user-group">
                                                <img src={item.teamMemberImg.img1} alt="user-image" className="avtar" data-bs-toggle="tooltip" data-bs-title="John Doe" />
                                                <img src={item.teamMemberImg.img2} alt="user-image" className="avtar" data-bs-toggle="tooltip" data-bs-title="Keefs" />
                                                <img src={item.teamMemberImg.img3} alt="user-image" className="avtar" data-bs-toggle="tooltip" data-bs-title="Lazaro" />
                                                <img src={item.teamMemberImg.img1} alt="user-image" className="avtar" data-bs-toggle="tooltip" data-bs-title="Adeline" />
