                    ...
                    <Card.Body className="position-relative">
                        <div className="text-center mt-3">
                            <div className="chat-avtar d-inline-flex mx-auto">
                                <img className="rounded-circle img-fluid wid-90 img-thumbnail"
                           ...
                           <li className="list-inline-item">
                                    <Link to="#" className="avtar avtar-s text-white bg-dribbble">
                                        <i className="ti ti-brand-dribbble f-24"></i>
                                    </Link>
                                </li>&nbsp;
                                <li className="list-inline-item">
                                    <Link to="#" className="avtar avtar-s text-white bg-amazon">
                                        <i className="ti ti-brand-figma f-24"></i>
                                    </Link>
                                </li>&nbsp;
                                <li className="list-inline-item">
                                    <Link to="#" className="avtar avtar-s text-white bg-pinterest">
                                        <i className="ti ti-brand-pinterest f-24"></i>
                                    </Link>
                                </li>&nbsp;
                                <li className="list-inline-item">
                                    <Link to="#" className="avtar avtar-s text-white bg-behance">
