                ...
                <div className="row gy-4">
                    <div className="col-xl-8">
                                            ...
                                            <tr>
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        <div className="flex-shrink-0">
                                                            <img src={product2} alt="image"
                                                                className="bg-light wid-50 rounded" />
                                                        </div>
                                                ...
                                                <td className="text-center">
                                                    <div className="btn-group btn-group-sm mb-2 border" role="group">
                                                        ...
                                                        <span className="wid-35 text-center border-0 m-0 form-control rounded-0 shadow-none">{count}</span>
                                                        <button type="button"
                                                ...
                                                <td className="text-end">
                                                    <Link to="#" className="avtar avtar-s btn-link-danger btn-pc-default">
                                                ...
                                                <td className="text-center">
                                                    <div className="btn-group btn-group-sm mb-2 border" role="group">
                                                        <button type="button"
                                                            ...
                                                            className="btn btn-link-secondary"><i
                                                                className="ti ti-minus"></i></button>
                                                        <span className="wid-35 text-center border-0 m-0 form-control rounded-0 shadow-none">{count1}</span>
                                                        <button type="button"
                                                ...
                                                <td className="text-center">
                                                    <div className="btn-group btn-group-sm mb-2 border" role="group">
                                                        <button type="button"
                                                            ...
                                                            className="btn btn-link-secondary"><i
                                                                className="ti ti-minus"></i></button>
                                                        <span className="wid-35 text-center border-0 m-0 form-control rounded-0 shadow-none">{count2}</span>
                                                        <button type="button"
                        ...
                        <div className="text-end">
                            <Link to="../application/ecom_product" className="btn btn-link-secondary d-inline-flex align-items-center">
