...
const EmailComposeModal = ({ show, handleClose }: modal) => {
    ...
    useEffect(()=>{
        const fetchEditor = async () => {
            const CKEditor = (await import('@ckeditor/ckeditor5-react')).CKEditor;
            let ClassicEditor = (await import('@ckeditor/ckeditor5-build-classic')).default;
                ...
                <Modal.Header>
                    ...
                    <ul className="list-inline me-auto mb-0">
                        <li className="list-inline-item align-bottom">
                            <Link to="#" className="avtar avtar-s btn-link-secondary" onClick={() => setModalSize(!modalSize)}>
                                <i className="ti ti-arrows-diagonal-2 f-18"></i></Link>
                        </li>
                        <li className="list-inline-item align-bottom">
                            <Link to="#" className="avtar avtar-s btn-link-danger" onClick={handleClose}>
                    ...
                    <div>
                        <div className="mb-3">
                            <div className="d-flex justify-content-end">
                                <Link to='#/' className="fw-semibold px-2" onClick={() => setRecipients(!recipients)} aria-expanded={recipients}>
                                    Cc & Bcc
                                </Link>
                            </div>
                        </div>
