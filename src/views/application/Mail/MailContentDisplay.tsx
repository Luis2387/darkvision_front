                            ...
                            <div className="d-sm-flex align-items-center">
                                <ul className="list-inline me-auto my-2">
                                    <li className="list-inline-item align-bottom">
                                        <Link to="#" className="avtar avtar-s btn-link-secondary" id="mail-back_inbox" onClick={() => setContant(false)}>
                                    ...
                                    <li className="list-inline-item">
                                        <div className="dropdown">
                                            ...
                                            <div className={`dropdown-menu dropdown-end ${display === 1 ? 'show show2' : ''}`}>
                                                <Link className="dropdown-item" to="#" onClick={handleDropDown}>Name</Link>
                                                <Link className="dropdown-item" to="#" onClick={handleDropDown}>Date</Link>
                                                <Link className="dropdown-item" to="#" onClick={handleDropDown}>Ratting</Link>
                                                <Link className="dropdown-item" to="#" onClick={handleDropDown}>Unread</Link>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div className="card bg-body border">
                                    <div className="card-body p-3">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <Link to="#" className="avtar avtar-xs btn-link-secondary text-secondary">
