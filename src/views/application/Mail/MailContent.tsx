...
const MailContent = ({ setMiniMailList, miniMailList, displayCategorys, displayTypes, displayLables,siteBarToggle,setSiteBarToggle}: any) => {
                ...
                <div className="d-md-flex align-items-center">
                    <ul className="list-inline me-auto mb-3">
                        <li className="list-inline-item align-bottom">
                            <Link to="#" className="d-xxl-none avtar avtar-s btn-link-secondary" data-bs-toggle="offcanvas"
                                data-bs-target="#offcanvas_mail" >
                                <i className="ti ti-menu-2 f-18"></i>
                            </Link>
                            <Link to="#" className={`d-none d-xxl-inline-flex avtar avtar-s btn-link-secondary ${siteBarToggle===true ? "show" :""}`} onClick={()=>setSiteBarToggle(!siteBarToggle)}>
                                <i className="ti ti-menu-2 f-18"></i>
                            </Link>
                        </li>
                        <li className="list-inline-item align-bottom">
                            <Link to="#" className="avtar avtar-s btn-link-secondary" onClick={() => setMiniMailList(!miniMailList)}>
