                                ...
                                <SimpleBar className={`scroll-block ${siteBarToggle===true ? 'simplebar-scrollable-y':''}`}>
                                    <Card.Body className="p-0">
                                        <div className="list-group list-group-flush" id="list-tab">
                                            <Link className={`list-group-item list-group-item-action ${activeTab === "Inbox" ? "active" : ''}`} to="#list-mail-1"
                                                onClick={() => toggleTab("Inbox", "all", "all")}>
                                                <span> <i className="ti ti-inbox"></i>  Inbox  </span>
                                                <span className="avtar avtar-xs">4</span>
                                            </Link>
                                            <Link className={`list-group-item list-group-item-action ${activeTab === "Sent" ? 'active' : ''}`} to="#list-mail-3"
                                                onClick={() => toggleTab("Sent", "all", "all")}>
                                                <span><i className="ti ti-send"></i> Sent </span>
                                            </Link>
                                            <Link className={`list-group-item list-group-item-action ${activeTab === "Draft" ? 'active' : ''}`} to="#list-mail-4"
                                                onClick={() => toggleTab("Draft", "all", "all")}>
                                                <span><i className="ti ti-file-text"></i> Draft</span>
                                            </Link>
                                            <Link className={`list-group-item list-group-item-action ${activeTab === "Spam" ? 'active' : ''}`} to="#list-mail-5"
                                                onClick={() => toggleTab("Spam ", "all", "all")}>
                                                <span><i className="ti ti-alert-triangle"></i> Spam </span>
                                            </Link>
                                            <Link className={`list-group-item list-group-item-action ${activeTab === "Trash" ? 'active' : ''}`} to="#list-mail-6"
                                                onClick={() => toggleTab("Trash", "all", "all")}>
                                                <span> <i className="ti ti-trash text-danger"></i>Trash</span>
                                                <span className="avtar avtar-xs">2</span>
                                            </Link>
                                            <Link className={`list-group-item list-group-item-action ${activeTab === "Archive" ? 'active' : ''}`} to="#list-mail-3"
                                            ...
                                            <Collapse in={mailCollapselist1} className="multi-collapse">
                                                <div id="mailCollapselist1">
                                                    <Link className="list-group-item list-group-item-action mt-3" to="#list-mail-7" onClick={() => toggleTab("all", "all", "Starred ")}>
                                                        <span> <i className="ti ti-star text-warning"></i> Starred </span>
                                                    </Link>
                                                    <Link className="list-group-item list-group-item-action" to="#list-mail-8" onClick={() => toggleTab("all", "all", "Important ")}>
                                            ...
                                            <Collapse in={mailCollapselist2} className="multi-collapse">
                                                <div id="mailCollapselist2">
                                                    <Link className="list-group-item list-group-item-action mt-3" to="#list-mail-7" onClick={() => toggleTab("all", "all", "Promotions")}>
                                                        <span><i className="ti ti-flag-3 text-primary"></i>  Promotions </span>
                                                        <span className="avtar avtar-xs">3</span>
                                                    </Link>
                                                    <Link className="list-group-item list-group-item-action" to="#list-mail-8" onClick={() => toggleTab("all", "all", "Forums")}>
                                                        <span> <i className="ti ti-flag-3 text-warning"></i> Forums</span>
                                                        <span className="avtar avtar-xs">1</span>
                                                    </Link>
                                                    <Link className="list-group-item list-group-item-action d-none" to="#list-mail-9" role="tab"></Link>
                                                </div>
                                            </Collapse>
                                        </div>
                                    </Card.Body>
