                    ...
                    <Col md={12}>
                        <Card>
                            <Card.Header>
                                ...
                                <small>The foundation for DataTables is progressive enhancement, so it is very adept at reading table information directly from the DOM.</small>
                            </Card.Header>
