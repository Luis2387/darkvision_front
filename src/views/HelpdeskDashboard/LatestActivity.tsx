                        ...
                        <div className="card-header-right">
                            <div className="btn-group card-option dropdown">
                                ...
                                <ul className={`list-unstyled card-option dropdown-menu dropdown-menu-end ${display === true ? "show show2" : ""}`}>
                                    <li className="dropdown-item full-card"><Link to="#!" onClick={handleDropDown}><span><i className="feather icon-maximize"></i>
                                        maximize</span><span style={{ display: "none" }}><i className="feather icon-minimize"></i>
                                            Restore</span></Link>
                                    </li>
                                    <li className="dropdown-item minimize-card"><Link to="#!" onClick={handleDropDown}><span><i className="feather icon-minus"></i>
                                        collapse</span><span style={{ display: "none" }}><i className="feather icon-plus"></i> expand</span></Link>
                                    </li>
                                    <li className="dropdown-item reload-card"><Link to="#!" onClick={handleDropDown}><i className="feather icon-refresh-cw"></i>
                                        reload</Link></li>
                                    <li className="dropdown-item close-card"><Link to="#!" onClick={handleDropDown}><i className="feather icon-trash"></i> remove</Link></li>
                                </ul>
                            </div>
                        </div>
                    </CardHeader>
