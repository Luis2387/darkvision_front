...
const Bio = () => {
    ...
    useEffect(() => {
        setIsClient(!isClient); // Set isClient to true when component mounts on the client
    }, []);
                ...
                <div className="tab-pane" id="educationDetail">
                    ...
                    <Modal show={showModal} onHide={handleClose} centered>
                        ...
                        <Modal.Body>
                            ...
                            <ReactQuill ref={quillRef} id="pc-quil-1" style={{ height: '125px', border: '1px solid #ced4da' }} placeholder='Type your text here...' className='mb-5 border-0' />
