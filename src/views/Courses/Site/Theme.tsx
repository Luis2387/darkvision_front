    ...
    return (
        <React.Fragment>
            ...
            <p className="text-muted mb-4">
                Incorporate a custom logo and favicon, and fine-tune your school thumbnail to enhance its appearance
                and branding
            </p>
            <Row className="g-3">
                <Col sm={12} md={4}>
            ...
            <div className="d-flex align-items-center mb-4">
                ...
                <div className="flex-grow-1 ms-3">
                    ...
                    <p className="mb-0 text-muted">
                        Personalize your school and eliminate Able Pro branding from your school website, emails, and
                        products. To access this feature, upgrade to the Professional plan.
                    </p>
                </div>
            </div>
            <h5>Font Family</h5>
            ...
            <div className="card border">
                <div className="card-body">
                    ...
                    <p className="mb-0 text-muted">
                        Make your school your own and remove Teachable branding from your school website, emails, and
                        all products. Upgrade to the Professional plan to use this feature.
                    </p>
                </div>
            </div>
            <h5>Color Palette</h5>
            <p className="text-muted mb-4">
                Select a predefined color scheme to establish consistency across your site and products. Alternatively,
                customize your own color palette to reflect your unique branding and preferences.
            </p>
