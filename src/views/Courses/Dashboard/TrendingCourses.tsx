                    ...
                    <CardBody className="px-0 py-2">
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <img src={bootstrap} alt="img" className="wid-40 rounded" />
                                    </div>
                            ...
                            <li className="list-group-item">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <img src={php} alt="img" className="wid-40 rounded"/>
                                    </div>
                                    <div className="flex-grow-1 mx-3">
                                        PHP Training Course
                                    </div>
                            ...
                            <li className="list-group-item">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <img src={ux} alt="img" className="wid-40 rounded"/>
                                    </div>
                                    <div className="flex-grow-1 mx-3">
                            ...
                            <li className="list-group-item">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <img src={web} alt="img" className="wid-40 rounded"/>
                                    </div>
                                    <div className="flex-grow-1 mx-3">
                            ...
                            <li className="list-group-item">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <img src={c} alt="img" className="wid-40 rounded"/>
                                    </div>
                                    <div className="flex-grow-1 mx-3">
                                        C Training Course
                                    </div>
