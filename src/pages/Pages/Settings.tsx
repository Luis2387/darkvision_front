...
const Settings = () => {
  ...
  return (
    <React.Fragment>
      <BreadcrumbItem mainTitle="Pages" subTitle="Settings" />
      <Row>
            ...
            <Card.Body>
              ...
              <Row className="">
                ...
                <Col lg={6} sm={7}>
                  ...
                  <Link to="#" className="link-primary text-sm">Need help?</Link>
                </Col>
              </Row>
              <Row className="mb-0">
                ...
                <Col lg={6} sm={7}>
                  ...
                  <Link to="#" className="link-primary text-smin">Need help?</Link>
                </Col>
              </Row>
