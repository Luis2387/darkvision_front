                    ...
                    <Card className="user-card">
                        <Card.Body>
                            <div className="user-cover-bg">
                                <img src={userCover} alt="image" className="img-fluid" />
                            ...
                            <div className="chat-avtar card-user-image">
                                <img src={avatar1} alt="user-image" className="img-thumbnail rounded-circle " />
                            ...
                            <div className="d-flex flex-wrap gap-2">
                                <div className="flex-grow-1">
                                    ...
                                    <p className="text-muted text-sm mb-0">DM on
                                        <Link to="#" className="text-primary"> @williambond</Link></p>
                                </div>
                    ...
                    <Card>
                        <Card.Body className="position-relative">
                            <div className="text-center mt-3">
                                ...
                                <p className="text-muted text-sm">DM on <Link to="#" className="link-primary"> @williambond </Link> 😍</p>
                                <ul className="list-inline mx-auto mt-4 mb-0">
                                    <li className="list-inline-item">
                                        <Link to="#" className="avtar avtar-s btn-light-secondary">
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="border rounded p-3 my-3">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <img src={avatar1} alt="user-image" className="avtar rounded-circle wid-45 hei-45" />
                                    </div>
                                    ...
                                    <Dropdown>
                                        <Dropdown.Toggle
                                            ...
                                            aria-expanded="false"
                                        >
                                            <i className="ti ti-chevron-down f-18"></i>
                                        </Dropdown.Toggle>
                                        <Dropdown.Menu className="dropdown-menu-end">
                                            <Dropdown.Item href="#">Today</Dropdown.Item>
                                            <Dropdown.Item href="#">Weekly</Dropdown.Item>
