            ...
            <Row>
                    ...
                    <Card>
                        ...
                        <ul className="list-group list-group-flush border-top-0">
                            <li className="list-group-item">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <img src={avatar1} width={50} alt="user-image" className="user-avtar rounded wid-50 hie-50" />
                                    </div>
                            ...
                            <li className="list-group-item">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <img src={avatar3} width={50} alt="user-image" className="user-avtar rounded wid-50 hie-50" />
                                    </div>
                                    <div className="flex-grow-1 mx-2">
                            ...
                            <li className="list-group-item">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <img src={avatar5} width={50} alt="user-image" className="user-avtar rounded wid-50 hie-50" />
                                    </div>
                                    <div className="flex-grow-1 mx-2">
                ...
                <Col xl={4} md={6}>
                    <Card>
                        ...
                        <CardBody className="table-body pt-0 px-0">
                                ...
                                <table className="table table-hover table-borderless mb-0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={GERMANY} alt="" className="img-fluid wid-30 rounded-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={USA} alt="" className="img-fluid wid-30 rounded-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={AUSTRALIA} alt="" className="img-fluid wid-30 rounded-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={UK} alt="" className="img-fluid wid-30 rounded-1" />
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={BRAZIL} alt="" className="img-fluid wid-30 rounded-1" />
