                ...
                <Card className="table-card">
                    <CardHeader>
                        <div className="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <Link to="../admins/course-teacher-apply.html" className="btn btn-outline-secondary">Apply Student List</Link>&nbsp;
                                <Link to="../admins/course-teacher-add.html" className="btn btn-primary">Add Student</Link>
                            </div>
                        </div>
                    </CardHeader>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <div className="flex-shrink-0">
                                                        <img src={item.img} alt="user image" className="img-radius wid-40" />
                                                    </div>
