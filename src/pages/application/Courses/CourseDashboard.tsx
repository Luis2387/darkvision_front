                        ...
                        <CardBody>
                            <div className="d-flex align-items-center justify-content-between">
                                ...
                                <div className="dropdown">
                                    <Link
                                        ref={dropdownRef}
                                        className={`avtar avtar-s btn-link-secondary dropdown-toggle arrow-none ${display === 31 ? 'show' : ""}`} to="#"
                    ...
                    <Card>
                        <CardBody>
                            <div className="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div className="dropdown">
                                    <Link className={`avtar avtar-s btn-link-secondary dropdown-toggle arrow-none ${display === 32 ? 'show' : ""}`} to="#"
                    ...
                    <Card>
                        <CardBody>
                            <div className="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div className="dropdown">
                                    <Link className={`avtar avtar-s btn-link-secondary dropdown-toggle arrow-none ${display === 34 ? "show" : ""}`} to="#"
