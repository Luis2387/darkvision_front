                ...
                cell: (cellProps: any) => {
                    return (
                        <div className="d-inline-block align-middle" >
                            <img src={cellProps.getValue()} alt="user image" className="img-radius align-top m-r-15" width={40} />
                        ...
                        <>
                            ...
                            <div className="overlay-edit">
                                <ul className="list-inline mb-0">
                                    <li className="list-inline-item m-0"><Link to="#" className="avtar avtar-s btn btn-primary"><i className="ti ti-pencil f-18"></i></Link></li>
                                    <li className="list-inline-item m-0"><Link to="#" className="avtar avtar-s btn bg-white btn-link-danger"><i className="ti ti-trash f-18"></i></Link></li>
                                </ul>
                            </div>
                        </>
                    )
