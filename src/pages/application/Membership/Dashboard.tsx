...
const Dashboard = () => {
    return (
        <React.Fragment>
            ...
            <Helmet title='Membership | Light Able admin and dashboard template offer a variety of UI elements and pages, ensuring your admin panel is both fast and effective.' />
            <Row>
                <SimpleData />
                <Col lg={7} md={12}>
                    <Card>
