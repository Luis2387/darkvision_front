            ...
            <Col md={6} lg={4}>
              <Card className="price-card p-4 border border-success border-2 h-100">
                <CardBody className="bg-success bg-opacity-10 rounded v3">
                  ...
                  <ul className="list-group list-group-flush product-list v3" style={{height: "198px"}}>
                  ...
                  <div className="d-grid"><Link className="btn btn-dark mt-4" to="#">Buy Now</Link></div>
                </CardBody>
              </Card>
            </Col>
            <Col md={6} lg={4}>
              <Card className="price-card p-4 border border-primary border-2 h-100">
                <CardBody className="bg-primary bg-opacity-10 rounded v3 v4">
                  <div className="price-head v3">
