...
import EcomDetails from "../../views/application/E-comerece/EcomDetails";
import {Link} from "react-router-dom";
import { Card, Col, Row } from "react-bootstrap";
import { useDispatch, useSelector } from "react-redux";
import { DeleteList, GetList} from "../../toolkit/E-commerce/reducer";
    ...
    const columns = useMemo(
        () => [
                    ...
                    return (
                        <div className="row">
                            <div className="col-auto pe-0">
                                <img src={cellProps.getValue()} alt="user-image" width={40} height={40} className="rounded" />
                            </div>
                            <div className="col">
            ...
            },
            {
                ...
                cell : (cellProps: any) => {
                    return (
                        <i className={ cellProps.row.original.status } data-bs-toggle="tooltip" data-bs-title="success">
                        </i>
                    )
                },
            },
            {
                ...
                cell: (cellProps: any) => {
                    return (
                        <React.Fragment>
                            <img src={cellProps.getValue()} alt="user-image" width={40} height={40} />
                            <div className="prod-action-links">
                                <ul className="list-inline me-auto mb-0">
                                    ...
                                    <li className="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Edit">
                                        <Link to="/application/ecom_product-add" className="avtar avtar-xs btn-link-success btn-pc-default">
                                            <i className="ti ti-edit-circle f-18"></i>
                                        </Link>
                                    </li>
                                    <li className="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Delete">
                                        <Link to="#!" className="avtar avtar-xs btn-link-danger btn-pc-default" onClick={() => handleDelete(cellProps.row.original.id)}>
                    ...
                    <Card className="table-card">
                        <Card.Body>
                            <div className="text-end p-sm-4 pb-sm-2">
                                <Link to="/application/ecom_product-add" className="btn btn-primary"> <i className="ti ti-plus f-18"></i> Add Product </Link>
                            </div>
                            <TableContainer
                                columns={(columns || [])}
                                data={(ecomLists || [])}
