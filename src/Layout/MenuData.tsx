const menuItems = [
    ...
    { id: "calendar", label: "Calender", link: "/application/calendar", icon: "ph-duotone ph-calendar-blank", dataPage: "calendar" },
    { id: "chat", label: "Chat", link: "/application/chat", icon: "ph-duotone ph-chats-circle", dataPage: "chat" },
    {
        ...
        submenu: [
            ...
            { id: "masonary", label: "Masonry", link: "/application/Gallary/masonary", dataPage: "masonary" },
        ]
    },
    {
        type: "HASHMENU", id: "ecom", label: "Ecommerce", link: "#", dataPage: null, icon: "ph-duotone ph-shopping-cart",
        submenu: [
            { id: "product", label: "Product", link: "/application/ecom_product", dataPage: "ecom_product" },
            { id: "productdetails", label: "Product-Detail", link: "/application/ecom_product-details", dataPage: "ecom_product-details" },
            { id: "productlist", label: "Product-List", link: "/application/ecom_product-list", dataPage: "ecom_product-list" },
            { id: "addnewproduct", label: "Product Add", link: "/application/ecom_product-add", dataPage: "ecom_product-add" },
    ...
    {
        type: "HASHMENU", id: "invoice1", label: "Invoice 1", dataPage: null, icon: "ph-duotone ph-newspaper", link: "#",
        submenu: [
            { id: "invoicelist", label: "List", link: "/application/invoice-list", dataPage: "invoice-list" },
    ...
    {
        type: "HASHMENU", id: "invoice2", label: "Invoice 2", dataPage: null, icon: "ph-duotone ph-newspaper", link: "#",
        submenu: [
    ...
    { id: "mail", label: "Mail", link: "/application/mail", icon: "ph-duotone ph-envelope-open", dataPage: "mail" },
    {
        ...
        submenu: [
            { id: "membershipdashboard", label: "Dashboard", link: "/admins/membership-dashboard", dataPage: "dashboard" },
            { id: "dashboardlist", label: "List", link: "/admins/membership-list", dataPage: 'list' },
            { id: "membershippricing", label: "Pricing", link: "/admins/membership-pricing", dataPage: 'pricing' },
    ...
    },
    {
        ...
        submenu: [
            { id: "coursesdashboard", label: "Dashboard", link: "/admins/course-dashboard", dataPage: "online" },
            {
                type: "HASHMENU", id: "teacher", label: "Teacher", link: "#", dataPage: null,
                submenu: [
                    { id: "teacherlist", label: "List", link: "/admins/course-teacher-list", dataPage: "teacher-list" },
                    { id: "teacherapply", label: "Apply", link: "/admins/course-teacher-apply", dataPage: "teacher-apply" },
                    { id: "teacheradd", label: "Add", link: "/admins/course-teacher-add", dataPage: "add" },
                ]
            },
            {
                type: "HASHMENU", id: "Student", label: "Student", link: "#", dataPage: null,
                submenu: [
                    { id: "studentlist", label: "List", link: "/admins/course-student-list", dataPage: "student-list" },
                    { id: "studentapply", label: "Apply", link: "/admins/course-student-apply", dataPage: "student-apply" },
                    { id: "studentadd", label: "Add", link: "/admins/course-student-add", dataPage: "add" },
                ]
            },
            {
                type: "HASHMENU", id: "courses", label: "Courses", link: "#", dataPage: null,
                submenu: [
                    { id: "courseview", label: "View", link: "/admins/course-course-view", dataPage: "view" },
                    { id: "courseadd", label: "Add", link: "/admins/course-course-add", dataPage: "add" },
                ]
            },
            { id: "coursepricing", label: "Pricing", link: "/admins/course-pricing", dataPage: "pricing" },
            { id: "coursessite", label: "Site", link: "/admins/course-site", dataPage: "site" },
            {
                type: "HASHMENU", id: "Setting", label: "Settings", link: "#", dataPage: "setting",
                submenu: [
                    { id: "payment", label: "Payment", link: "/admins/course-setting-payment", dataPage: "payment" },
                    { id: "settingpricing", label: "Pricing", link: "/admins/course-setting-pricing", dataPage: "pricing" },
    ...
    {
        type: "HASHMENU", id: "users", label: "User", dataPage: null, icon: "ph-duotone ph-user-circle", link: "#",
        submenu: [
        ...
        submenu: [
            ...
            },
            {
                ...
                submenu: [
                    ...
                    { id: "forgotpw2", label: "Forget password", link: "/pages/forgot-password-v2", dataPage: "pages-forgot-password-v2" },
    ...
    { id: "loading", label: "Loading", link: "/pages/loading", icon: "ph-duotone ph-fan", dataPage: "loading" },
    {
        ...
        submenu: [
            { id: "search", label: "Search Page", link: "/pages/search-page", dataPage: "search" },
    ...
    { id: "animation", label: "Animation", icon: "ph-duotone ph ph-flower", link: "/elements/animation", dataPage: "animation" },
    {
        ...
        submenu: [
            ...
            { id: "icon-phosphor", label: "Phospher", link: "/elements/icon-phosphor", dataPage: "icon-phosphor" },
            { id: "icon-custom", label: "Custom", link: "/elements/icon-custom", dataPage: "icon-custom" }
        ]
    },
    { label: "Forms", type: "HEADER" },
    {
        type: "HASHMENU", id: "form", label: "Form Elements", icon: "ph-duotone ph-textbox", dataPage: null,
        submenu: [
            ...
            { id: "inputgroup", label: "Input Group", link: "/forms/form2_input_group", dataPage: "forms-form2_input_group" },
    ...
    {
        type: "HASHMENU", id: "Form Plugins", label: "Forms Plugins", dataPage: null, icon: "ph-duotone ph-plug-charging", link: "#",
        submenu: [
            {
                type: "HASHMENU", id: "date", label: "Date", link: "#", dataPage: null,
                submenu: [
                    { id: "datepicker", label: "Date Picker", link: "/forms/form2_datepicker", dataPage: "forms-form2_datepicker" },
    ...
    {
        type: "HASHMENU", id: "textedit", label: "Text Editor", dataPage: null, icon: "ph-duotone ph-pen-nib", link: "#",
        submenu: [
    ...
    },
    {
        ...
        submenu: [
            ...
            { id: "stickyaction", label: "Sticky-ActionBar", link: "/forms/form2_lay_stickyactionbars", dataPage: "forms-form2_lay_stickyactionbars" }
        ]
    },
    {
    ...
    { id: "Wizard", label: "wizard", icon: "ph-duotone ph-password", link: "/forms/form2_wizard", dataPage: "forms-form_wizard" },
    ...
    {
        id: "imagecropper", label: "Images Cropper", icon: "ph-duotone ph-crop", link: "/forms/image_crop", dataPage: "forms-image_crop"
    },
    ...
    },
    {
        ...
        submenu: [
            ...
            { id: "addrows", label: "Add Rows", link: "/table/tbl_dt-add-rows", dataPage: "table-tbl_dt_add-rows" },
            { id: "fetchapi", label: "Fetch API", link: "/table/tbl_dt_fetch-api", dataPage: "table-tbl_dt-fetch-api" },
    ...
    {
        type: "HASHMENU", id: "dtextentions", label: "DT extensions", dataPage: null, link: "#", icon: "ph-duotone ph-wall",
        submenu: [
            { id: "autofill", label: "Autofill", link: "/table/dt_ext_autofill", dataPage: "table-dt_advance" },
            {
                ...
                submenu: [
                    { id: "basic", label: "Basic button", link: "/table/dt_ext_basic_buttons", dataPage: "table-dt_basic_buttons" },
                    { id: "dataexport", label: "Data export", link: "/table/dt_ext_export_buttons", dataPage: "table-dt_data_exports" },
                ]
            },
            ...
            { id: "fixedheaders", label: "Fixed header", link: "/table/dt_ext_fixed_header", dataPage: "table-dt_fixed_header" },
    ...
    { label: "Charts", type: "HEADER" },
    {
        ...
        submenu: [
            ...
            { id: "pietychart", label: "Peity Chart", link: "/chart/chart-piety", dataPage: "chart-piety" }
        ]
    },
    {
        type: "HASHMENU", id: "maps", label: "Map", dataPage: null, icon: "ph-duotone ph-map-trifold", link: "#",
        submenu: [
            { id: "vectormap", label: "Vector Map", link: "/chart/map-vector", dataPage: "map-vector" },
            // { id: "gmap", label: "Google Map", link: "/chart/g-maps", dataPage: "g-maps" }
        ]
    },
